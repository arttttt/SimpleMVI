...
class TCAFeatureProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        valid
            ...
            .forEach { processStore(it, resolver) }

        return invalid
    }

    @OptIn(KspExperimental::class)
    private fun processStore(storeClass: KSClassDeclaration, resolver: Resolver) {
        // Извлекаем типы Store<Intent, State, SideEffect>
